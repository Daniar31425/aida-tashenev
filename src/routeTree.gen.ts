...
import { Route as HrAppRouteImport } from './routes/hr-app'
...
const HrAppRoute = HrAppRouteImport.update({
  id: '/hr-app',
  path: '/hr-app',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    '/hr-app': {
      ...
      path: '/hr-app'
      fullPath: '/hr-app'
      preLoaderRoute: typeof HrAppRouteImport
